...
/**
 * The function `LoginUser` is an asynchronous function that sends a POST request to a specified
 ...
 * @returns The function `LoginUser` returns a Promise that resolves to a response data object if the
